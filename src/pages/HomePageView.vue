...
<template>
  <div class="HomePageView">
    ...
    <div class="Content">
      <!-- Icon -->
      <div class="LogoImage rainbow-border">
...
/* HomePageView Content link hover */
.HomePageView .Content a:hover {
